...
parser.add_argument('--case_sample_seg_path', type=str, required=True,
					help='case sample tumor.seg path')
parser.add_argument('--control_sample_seg_path', type=str, required=True,
					help='control sample tumor.seg path')
...
main(args.pair_id, args.case_sample_id, args.control_sample_id, args.case_sample_seg_path, args.control_sample_seg_path)
